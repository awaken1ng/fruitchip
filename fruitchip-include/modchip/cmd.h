...
#define MODCHIP_CMD_GROUP1 0x1c

#define MODCHIP_CMD_TEST_DATA_OUT_WITH_STATUS_NO_DATA_NO_CRC     ((0x18cd << 16) | (MODCHIP_CMD_GROUP1 << 8) | MODCHIP_CMD_PREFIX)
#define MODCHIP_CMD_TEST_DATA_OUT_WITH_STATUS_WITH_DATA_NO_CRC   ((0x2a0b << 16) | (MODCHIP_CMD_GROUP1 << 8) | MODCHIP_CMD_PREFIX)
#define MODCHIP_CMD_TEST_DATA_OUT_WITH_STATUS_WITH_DATA_WITH_CRC ((0x7864 << 16) | (MODCHIP_CMD_GROUP1 << 8) | MODCHIP_CMD_PREFIX)
#define MODCHIP_CMD_TEST_DATA_OUT_NO_STATUS_WITH_DATA_WITH_CRC   ((0x241d << 16) | (MODCHIP_CMD_GROUP1 << 8) | MODCHIP_CMD_PREFIX)
#define MODCHIP_CMD_TEST_DATA_OUT_NO_STATUS_WITH_DATA_NO_CRC     ((0x111f << 16) | (MODCHIP_CMD_GROUP1 << 8) | MODCHIP_CMD_PREFIX)
#define MODCHIP_CMD_TEST_DATA_OUT_BUSY                           ((0x5ca7 << 16) | (MODCHIP_CMD_GROUP1 << 8) | MODCHIP_CMD_PREFIX)
...
#define MODCHIP_CMD_READ_EE_STAGE3           ((0x7338 << 16) | (MODCHIP_CMD_GROUP0 << 8) | MODCHIP_CMD_PREFIX)
#define MODCHIP_CMD_READ_APP                 ((0x33b8 << 16) | (MODCHIP_CMD_GROUP0 << 8) | MODCHIP_CMD_PREFIX)
...
#define MODCHIP_CMD_FW_GIT_REV               ((0x1e6a << 16) | (MODCHIP_CMD_GROUP0 << 8) | MODCHIP_CMD_PREFIX)
#define MODCHIP_CMD_BOOTLOADER_GIT_REV       ((0x1b57 << 16) | (MODCHIP_CMD_GROUP0 << 8) | MODCHIP_CMD_PREFIX)
